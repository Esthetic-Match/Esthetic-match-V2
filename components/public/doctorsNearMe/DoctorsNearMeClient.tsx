...
type DoctorCardDto = {
  ...
  /*
   * Database-backed catalogue values.
   */
...
function toDoctorCardData(
  ...
  return {
    ...
    /*
     * Already localized and resolved by
...
function isDoctorsNearMeResponse(
  ...
  const candidate =
    value as Partial<DoctorsNearMeResponse>;
...
export default function DoctorsNearMeClient() {
  ...
  const [
    ...
    useState<DoctorsNearMeResponse | null>(
      null,
    );
  ...
  const handleDoctorsNearMeSuccess =
    useCallback(
      async (
        position: GeolocationPosition,
      ) => {
  ...
  const loadDoctorsNearMe =
    useCallback(() => {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          void handleDoctorsNearMeSuccess(
            position,
          );
        },
