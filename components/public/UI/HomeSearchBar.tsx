...
import DoctorFiltersModal from "@/components/UI/DoctorFiltersModal";
  ...
  <>
    <div className="flex w-full max-w-5xl flex-col gap-3 rounded-[2rem] bg-white p-3 shadow-2xl shadow-[#283C5D]/10 md:flex-row md:items-center md:rounded-full">
      ...
      <button
        ...
        className="flex shrink-0 items-center justify-center gap-2 rounded-full border border-black/40 bg-white px-5 py-3 text-sm font-semibold text-[#283C5D] transition hover:bg-[#283C5D] hover:text-white cursor-pointer"
      >
      ...
      <button
        ...
        className="shrink-0 rounded-full bg-[#d8bd8d] px-6 py-3 text-sm font-semibold text-[#061A2D] transition hover:bg-[#f4e4c6] cursor-pointer"
      >
        {t("hero.search")}
      </button>
    </div>
