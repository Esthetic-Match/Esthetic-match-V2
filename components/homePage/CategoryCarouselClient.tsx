...
<div className="relative">
  ...
  <button
    ...
    className="absolute left-0 top-1/2 z-20 flex h-9 w-9 -translate-y-1/2 cursor-pointer items-center 
    justify-center rounded-full bg-white/90 text-[#283C5D] shadow-md transition hover:bg-[#283C5D] hover:text-white active:scale-[0.95]"
  >
    <ChevronLeft size={20} />
  </button>
  ...
  <button
    ...
    className="absolute right-0 top-1/2 z-20 flex h-9 w-9 -translate-y-1/2 cursor-pointer items-center 
    justify-center rounded-full bg-white/90 text-[#283C5D] shadow-md transition hover:bg-[#283C5D] hover:text-white active:scale-[0.95]"
  >
