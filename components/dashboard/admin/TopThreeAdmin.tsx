      ...
      try {
        ...
        setSelectedDoctorUserId(
          (
            ...
            const currentDoctorStillExists =
              doctorList.some(
                (doctor) =>
                  doctor.userId ===
                  currentDoctorUserId
...
function DoctorTopThreeEditor({
  doctor,
}: DoctorTopThreeEditorProps) {
  ...
  useEffect(() => {
    ...
    async function fetchTopThree(): Promise<void> {
      try {
        ...
        const response =
          await fetch(
            `/api/admin/doctors/${encodeURIComponent(
              doctor.userId
            )}/top-three?locale=${encodeURIComponent(
              locale
            )}`,
            {
              method: "GET",
        ...
        const doctorData =
          data as DoctorTopThreeResponse;
    ...
    <div className="mt-6 border-t border-[#283C5D]/10 pt-6">
      ...
      !error ? (
        ...
        0 ? (
          ...
          <div className="mt-5 rounded-2xl border border-dashed border-[#283C5D]/15 bg-[#FAF9F7] px-4 py-4 text-sm text-[#283C5D]/60">
            This doctor does not
            currently have any top
            procedures selected.
          </div>
        )
      ) : null}
      ...
      procedureIds.length ===
        ...
        <p className="mt-4 text-sm text-amber-700">
          Add procedures to this
          doctor before selecting
          their top three.
        </p>
      ) : null}
      ...
      {isModalOpen ? (
        <TopThreeProceduresModal
          ...
          onSaved={(
            ...
            /*
             * Reload so topRank and
             * translated procedure
             * data remain in sync.
             */
            setReloadKey(
              (currentKey) =>
