...
import { Loader2, ShieldCheck, CreditCard, Building2 } from "lucide-react";
      ...
      <div className="rounded-[2rem] border border-black/10 bg-white p-6 shadow-lg md:p-8">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <PriceCard
            ...
            description="The price patients pay for appointments at your clinic."
            value={inClinicPrice}
            onChange={setInClinicPrice}
            placeholder="100"
          />
        ...
        <div className="mt-8 flex flex-col gap-3 md:flex-row md:justify-end">
          <button
            ...
            onClick={finishLater}
            disabled={loading}
            className="rounded-full border border-black px-6 py-3 text-sm font-medium text-black transition hover:bg-gray-100 active:scale-[0.98] disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center rounded-full bg-[#283C5D] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-90 active:scale-[0.98] disabled:opacity-50"
          >
            {loading ? (
              <>
