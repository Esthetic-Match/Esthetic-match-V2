...
import { X, Star, MapPin, SlidersHorizontal  } from "lucide-react";
...
return (
<div className="fixed inset-0 z-50 bg-black/50 px-3 py-4 backdrop-blur-sm md:flex md:items-center md:justify-center md:px-4 md:py-6">
  <div className="relative mt-16 mx-auto flex h-[calc(90dvh-2rem)] w-full max-w-6xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl md:h-auto md:max-h-[88vh]">
    <div className="shrink-0 border-b border-black/10 px-4 py-4 md:px-6 md:py-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-black/10 text-[#283C5D] transition hover:bg-[#283C5D] hover:text-white active:scale-[0.97]"
        >
          <X size={18} />
        </button>
      </div>
      ...
      <div className="mt-4 md:hidden">
        <button
          ...
          className="flex w-full items-center justify-between rounded-full border border-black/10 bg-[#FAF9F7] px-4 py-3 text-sm font-semibold text-[#283C5D] transition active:scale-[0.98]"
        >
          <span>{t("filters")}</span>
    ...
    <div className="hidden shrink-0 bg-[#FAF9F7] p-6 md:block">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto md:grid md:overflow-hidden md:grid-cols-[0.85fr_1.4fr]">
        ...
        <div className="bg-white p-4 md:h-[52vh] md:overflow-y-auto md:p-6">
          <div className="sticky -top-4 z-10 mb-4 flex items-end justify-between gap-4 bg-white pb-4 pt-2 md:-top-6 md:pt-5">
            <div>
      ...
      <div className="shrink-0 flex items-center justify-between gap-3 border-t border-black/10 bg-white px-4 py-4 md:px-6 md:py-5">
        <button
          ...
          className="rounded-full border border-black/10 px-5 py-3 text-sm font-semibold text-[#283C5D] transition hover:bg-black/5 active:scale-[0.97] md:px-6"
        >
          {t("clear")}
        </button>
        ...
        <button
          ...
          className="rounded-full bg-[#d8bd8d] px-6 py-3 text-sm font-semibold text-[#061A2D] transition hover:bg-[#f4e4c6] active:scale-[0.97] md:px-7"
        >
          {t("apply")}
        </button>
      </div>
