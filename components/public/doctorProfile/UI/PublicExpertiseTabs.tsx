...
export type PublicExpertiseCategoryGroup = {
  ...
  subcategories:
    PublicExpertiseSubcategoryGroup[];
};

type PublicExpertiseTabsProps = {
  categories:
    PublicExpertiseCategoryGroup[];
...
export function PublicExpertiseTabs({
  ...
  const activeCategory =
    useMemo<PublicExpertiseCategoryGroup | null>(
      () => {
        return (
          categories.find(
            (category): boolean =>
  ...
  function openProcedure(
    procedure: PublicExpertiseProcedure
  ) {
    setSelectedProcedure({
      id: procedure.id,
    ...
    <>
      <div className="space-y-7">
        <div
          ...
          className={[
            "flex gap-8 overflow-x-auto border-b border-white/10 pb-1",
                ...
                <button
                  ...
                  className={[
                    ...
                    isActive
                      ...
                      : "text-white/65 after:scale-x-0 after:bg-[#d8bd8d] hover:text-white hover:after:scale-x-100",
                  ].join(" ")}
                >
                  {category.label}
                </button>
                        ...
                        (
                          ...
                          >
                            <button
                              ...
                              className="group inline-flex max-w-full cursor-pointer items-center gap-2 whitespace-normal rounded-full border border-black/10 bg-white px-5 py-2 text-sm font-medium text-[#283C5D] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#D8BD8D] hover:bg-[#F8F3EA] hover:shadow-md active:translate-y-0"
                            >
